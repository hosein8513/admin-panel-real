...
const Action = ({ rowData, handleDeleteProduct }) => {
  ...
  return (
    <>
      ...
      ></i>
      <i className='fas fa-images text-success mx-1 hoverable-text pointer has-tooltip' title='مدیریت گالری' onClick={() => navigation('/products/gallery', { state: { selectedProduct: rowData } })}></i>
      <i
